"""History table/view feature helpers."""
...
def populate_table_impl(self, items, theme, TYPE_ICONS):
    ...
    for row_idx, item_data in enumerate(items):
        ...
        if ptype == "LINK":
            ...
            content_item.setForeground(QColor(theme["primary"]))
        ...
        try:
            ...
            if dt.date() == today:
                ...
                time_str = f"어제 {dt.hour}시"
            else:
                time_str = f"{dt.month}/{dt.day} {dt.hour}시"
